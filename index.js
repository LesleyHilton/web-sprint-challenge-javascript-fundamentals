...
//nestedFunction can access the variable "internal" because it's declared within the function myFunction, and nestedFunction is nested within myFunction. Const is block-scoped, which means it's accessible in the block in which it's declared. //
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooInfo){

    const displayNames = [];
    zooInfo.forEach(function(element){
  ...
  */
  ...
  function lowerCaseNames(data){
    const newList = data.map(function(item){
...
console.log(lowerCaseNames(zooAnimals));
  ...
  */
  ...
  console.log("request 4", lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(animalPop){
    const totalPop = animalPop.reduce(function(accumulator, item){
